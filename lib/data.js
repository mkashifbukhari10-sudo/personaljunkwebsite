...
export const clutterBlocks = [
  { label: 'SOFA', left: 5, width: 22, height: 30, shade: '#C3C9D2' },
  { label: 'FRIDGE', left: 29, width: 11, height: 46, shade: '#CDD3DB' },
  { label: 'MATTRESS', left: 42, width: 17, height: 15, shade: '#B9C0CA' },
  { label: 'BOXES', left: 62, width: 12, height: 24, shade: '#C9CFD8' },
  { label: 'CHAIRS', left: 76, width: 8, height: 34, shade: '#BFC6D0' },
  { label: 'GARDEN WASTE', left: 86, width: 10, height: 18, shade: '#C6CCD5' }
];
